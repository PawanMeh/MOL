...
def get_columns(leave_types):
	...
	for leave_type in leave_types:
		columns.append(_(leave_type) + " " + _("Leave opening") + ":Float:160")
		columns.append(_(leave_type) + " " + _("Leaves Added") + ":Float:160")
...
def get_data(filters, leave_types):
	...
	allocation_records_based_on_to_date_prev_year = get_leave_allocation_records(frappe.utils.add_days(filters.from_date, -1))
	...
	for employee in active_employees:
		...
		for leave_type in leave_types:
			...
			#prev_year_opening
			prev_year_end_date = frappe.utils.add_days(filters.from_date, -1);
